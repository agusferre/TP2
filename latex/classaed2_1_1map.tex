...
\begin{DoxyCompactList}\small\item\em Inserta o redefine \{value\} en el diccionario. \end{DoxyCompactList}\item 
...
\hyperlink{classaed2_1_1map_a719db98e0ff9a837610f76be33264680}{value\_type}(\textcolor{keyword}{const} \hyperlink{classaed2_1_1map_a719db98e0ff9a837610f76be33264680}{value\_type}& other);

\textcolor{comment}{//Destructor de los valores}
\textcolor{comment}{//Complejidad: O(del(*this))}
~\hyperlink{classaed2_1_1map_a719db98e0ff9a837610f76be33264680}{value\_type}();

\textcolor{keyword}{struct }Compare \{
  \textcolor{comment}{//Comparacion de dos valores}
  \textcolor{comment}{//Complejidad: O(cmp(v1, v2))}
  \textcolor{keywordtype}{bool} operator()(\textcolor{keyword}{const} \hyperlink{classaed2_1_1map_a719db98e0ff9a837610f76be33264680}{value\_type}& v1, \textcolor{keyword}{const} \hyperlink{classaed2_1_1map_a719db98e0ff9a837610f76be33264680}{value\_type}& v2) \textcolor{keyword}{const};
\};
\end{DoxyCode}
...
\begin{DoxyAttention}{Attention}
El parámetro formal  del T\+AD diccionario se establece en esta función.  es igual al operator() del comparador de \{other\} 
\end{DoxyAttention}
...
\{
\begin{DoxyItemize}
\item En el peor caso\+: ((\{res\})((\{res\}))  (\{res\}))
\item Si el rango \mbox{[}\{first\}, \{last\}) está ordenado\+: ((\{res\})  (\{res\})) \}
\end{DoxyItemize}
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_af3b1818c2b44e37221cc3b131768555b}\label{classaed2_1_1map_af3b1818c2b44e37221cc3b131768555b}} 
\index{aed2\+::map@{aed2\+::map}!begin@{begin}}
\index{begin@{begin}!aed2\+::map@{aed2\+::map}}
...
\{\{$\ast$this\}  vacio\}
\end{DoxyPostcond}
\{((\{$\ast$this\}))\} \mbox{\Hypertarget{classaed2_1_1map_a6ad62765a2b2e00247b9e35a7542b448}\label{classaed2_1_1map_a6ad62765a2b2e00247b9e35a7542b448}} 
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_a76023e6a56cb625513e1b5ea028bf983}\label{classaed2_1_1map_a76023e6a56cb625513e1b5ea028bf983}} 
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_a91e7cad1a638c55659c169d5574cd5d7}\label{classaed2_1_1map_a91e7cad1a638c55659c169d5574cd5d7}} 
\index{aed2\+::map@{aed2\+::map}!end@{end}}
\index{end@{end}!aed2\+::map@{aed2\+::map}}
...
\end{DoxyItemize}\mbox{\Hypertarget{classaed2_1_1map_a2ffadb42cd5f0bc7b3752ff159b75334}\label{classaed2_1_1map_a2ffadb42cd5f0bc7b3752ff159b75334}} 
\index{aed2\+::map@{aed2\+::map}!erase@{erase}}
\index{erase@{erase}!aed2\+::map@{aed2\+::map}}
...
\{completar\}
\end{DoxyPostcond}
\{((\{$\ast$pos\}) + ((\{$\ast$this\}))  (\{$\ast$this\}))\} \mbox{\Hypertarget{classaed2_1_1map_afd0fc1a8234888e61e0e615de7e245b8}\label{classaed2_1_1map_afd0fc1a8234888e61e0e615de7e245b8}} 
...
Inserta o redefine \{value\} en el diccionario. 

Inserta un valor en el diccionario. Si \{$\ast$this\} ya tiene un valor con clave \{value\}.first, entonces se redefine. El iterador de retorno apunta al elemento recien insertado o redefinido.


\begin{DoxyParams}{Parameters}
{\em value} & valor a insertar \\
\hline
{\em hint} & iterador apuntando al diccionario. Se espera que apunte al mínimo valor mayor o igual a \{value\}.first (i.\+e., a lower\+\_\+bound(\{value\}.first)). Igualmente, la función es robusta y funciona correctamente aunque esto no ocurra. \\
\hline
\end{DoxyParams}
...
\{completar\}
\end{DoxyPostcond}
\{(((\{$\ast$this\}))  (\{$\ast$this\}))\} \mbox{\Hypertarget{classaed2_1_1map_a07b3dd65557c59ee085e5f211269c6b3}\label{classaed2_1_1map_a07b3dd65557c59ee085e5f211269c6b3}} 
\index{aed2\+::map@{aed2\+::map}!lower\+\_\+bound@{lower\+\_\+bound}}
\index{lower\+\_\+bound@{lower\+\_\+bound}!aed2\+::map@{aed2\+::map}}
...
Devuelve el significado asociado a \{key\}. Si \{key\} no está definido en \{$\ast$this\}, entonces se inserta un nuevo valor con clave \{key\} y significado \{Value\}(). De esta forma, podemos usar {\ttfamily operator\mbox{[}\mbox{]}} para definir nuevos valores o modificar los existentes.
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_a71ab53ab04f5e35a189c6576fddeb483}\label{classaed2_1_1map_a71ab53ab04f5e35a189c6576fddeb483}} 
\index{aed2\+::map@{aed2\+::map}!rbegin@{rbegin}}
\index{rbegin@{rbegin}!aed2\+::map@{aed2\+::map}}
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_a7cf14a4b505505d0f074034b7399fb24}\label{classaed2_1_1map_a7cf14a4b505505d0f074034b7399fb24}} 
\index{aed2\+::map@{aed2\+::map}!rend@{rend}}
\index{rend@{rend}!aed2\+::map@{aed2\+::map}}
...
\{completar\}
\end{DoxyPostcond}
\{(1)\} \mbox{\Hypertarget{classaed2_1_1map_a43ddb71cc91e5c6021a7a1f243d6cc4a}\label{classaed2_1_1map_a43ddb71cc91e5c6021a7a1f243d6cc4a}} 
