...
\end{DoxyPostcond}
\{(1)\} \-Inicia un iterador en raíz, y va iterando hacia la izquierda hasta llegar al elemento más chico. \-Devuelve el iterador. \hypertarget{classaed2_1_1map_a1d10432d305bcb5f1af6ab7b75c27c1c}{\index{aed2\-::map@{aed2\-::map}!begin@{begin}}
\index{begin@{begin}!aed2::map@{aed2\-::map}}
...
\-Inicia un iterador en raíz, y va iterando hacia la derecha hasta llegar al elemento más grande. \-Devuelve el iterador. \hypertarget{classaed2_1_1map_a1f847ad4fd46883ac60d764967172179}{\index{aed2\-::map@{aed2\-::map}!end@{end}}
\index{end@{end}!aed2::map@{aed2\-::map}}
...
\end{DoxyItemize}it = lower\-\_\-bound(key); if (it.\-nodo-\/$>$value\-\_\-.\-key() == key) return value\-\_\--\/$>$second; else insert(it, value(key, Meaning))\hypertarget{classaed2_1_1map_ac412d3902112122c1bffe2d4283a4e9d}{\index{aed2\-::map@{aed2\-::map}!rbegin@{rbegin}}
