...
\-En el enunciado del \-T\-P hay algunas funciones que muestran cómo describir los aspectos de aliasing.\hypertarget{Aliasing_sec-puntero}{}\subsection{Álgebra vs. computadora}\label{Aliasing_sec-puntero}
