...
En el enunciado del TP hay algunas funciones que muestran cómo describir los aspectos de aliasing.\hypertarget{Aliasing_sec-puntero}{}\section{Álgebra vs. computadora}\label{Aliasing_sec-puntero}
