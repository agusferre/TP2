...
rep\+\_\+iter(n) $\equiv$ n $=_{\rm obs}$ $\bot$ $\lor_{\rm L}$ \mbox{[}(n) $\land_{\rm L}$ header\+Valido(llegar\+Al\+Header(n)) $\land$ get(n.\+parent) = 0 $\lor$ arbol\+Binario\+De\+Busqueda(llegar\+A\+L\+Header(n).parent) $\land$ ( $\forall$ n\textquotesingle{}\+: \hyperlink{structaed2_1_1map_1_1Node}{Node}) nodo\+Hijo(n\textquotesingle{}, $\ast$llegar\+A\+L\+Header(n)) $\Rightarrow$ ((get(n\textquotesingle{}.child\mbox{[}0\mbox{]}) = 0 $\lor_{\rm L}$ n\textquotesingle{}.chiild\mbox{[}0\mbox{]}.color = Black) $\land$ (get(n\textquotesingle{}.child\mbox{[}1\mbox{]}) = 0 $\lor_{\rm L}$ n\textquotesingle{}.chiild\mbox{[}1\mbox{]}.color = Black) $\land$ nodos\+Negros(n\textquotesingle{}.child\mbox{[}0\mbox{]}) = nodos\+Negros(n\textquotesingle{}.child\mbox{[}1\mbox{]})\mbox{]} rep\+\_\+iter(n) $\equiv$ 1 $\land$ 2 $\land$ 3 $\land$ 4

1) El iterador apunta a null o a un arbol 2) El arbol es abb 3) Es Roji-\/negro válido 4) Los hijos del header apuntan al mínimo y al máximo. \begin{DoxyParagraph}{Función de abstracción}

\end{DoxyParagraph}
abs\+\_\+iter\+: puntero(\+Node) n $\to$ Iterador\+Bidireccional(Diccionario(Key, Meaning), tupla(Key, Meaning)) \{rep\+\_\+iter(n)\}~\newline
abs\+\_\+iter(n) $\equiv$ it\+: Iterador\+Bidireccional(Diccionario(Key, Meaning), tupla(Key, Meaning)) ¿ $\land$? Siguientes(it) $=_{\rm obs}$ Dicc\+Secu(\+Map\+A\+Conjunto(d)) $\land$ Anteriores(it) $=_{\rm obs}$
...
Definición en la línea \hyperlink{map_8h_source_l01636}{1636} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
=======
Definición en la línea \hyperlink{map_8h_source_l01833}{1833} del archivo \hyperlink{map_8h_source}{map.\+h}.
>>>>>>> 3351839d08a90c48e32205c7950dbc4f8de61640
...
\end{DoxyRetVals}
\begin{DoxyParagraph}{Aspectos de aliasing\+:}
Se invalida si el elemento apuntado es eliminado // res es una referencia al valor que apunta {\bfseries $\ast$this}
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondición}
...
=======
Definición en la línea \hyperlink{map_8h_source_l01687}{1687} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
=======
Definición en la línea \hyperlink{map_8h_source_l01705}{1705} del archivo \hyperlink{map_8h_source}{map.\+h}.
>>>>>>> 3351839d08a90c48e32205c7950dbc4f8de61640
