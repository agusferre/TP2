...
<<<<<<< HEAD
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{res $=_{obs}$ $\ast${\bfseries $\ast$this}\}
=======
\begin{DoxyPostcond}{Postcondición}
...
<<<<<<< HEAD
\-Definición en la línea \hyperlink{map_8h_source_l01773}{1773} del archivo \hyperlink{map_8h_source}{map.\-h}.
=======
...
<<<<<<< HEAD
\begin{DoxyPrecond}{\-Precondición}
{\bfseries \-P} $\equiv$ \{{\bfseries $\ast$this} $=_{obs}$ it\-\_\-0 $\land$ \-Hay\-Siguiente({\bfseries $\ast$this})\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{{\bfseries $\ast$this} $=_{obs}$ res $\land$ res $=_{obs}$ \-Avanzar(it\-\_\-0)\}
=======
\begin{DoxyPrecond}{Precondición}
...
<<<<<<< HEAD
\begin{DoxyPrecond}{\-Precondición}
{\bfseries \-P} $\equiv$ \{{\bfseries $\ast$this} $=_{obs}$ it\-\_\-0 $\land$ \-Hay\-Siguiente(it\-\_\-0)\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{res $=_{obs}$ it\-\_\-0 $\land$ {\bfseries $\ast$this} $=_{obs}$ \-Avanzar(it\-\_\-0)\}
=======
\begin{DoxyPrecond}{Precondición}
...
<<<<<<< HEAD
\begin{DoxyPrecond}{\-Precondición}
{\bfseries \-P} $\equiv$ \{{\bfseries $\ast$this} $=_{obs}$ it\-\_\-0 $\land$ \-Hay\-Anterior({\bfseries $\ast$this})\} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{{\bfseries $\ast$this} $=_{obs}$ res $\land$ res $=_{obs}$ \-Retroceder(d\-\_\-0)\}
=======
\begin{DoxyPrecond}{Precondición}
...
<<<<<<< HEAD
\-Definición en la línea \hyperlink{map_8h_source_l01848}{1848} del archivo \hyperlink{map_8h_source}{map.\-h}.
=======
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{res $=_{obs}$ it\-\_\-0 $\land$ {\bfseries $\ast$this} $=_{obs}$ \-Retroceder(it\-\_\-0)\}
=======
\begin{DoxyPrecond}{Precondición}
{\bfseries P} $\equiv$ \{this $=_{\rm obs}$ it\+\_\+0 $\land$ Hay\+Anterior(this)\} 
\end{DoxyPrecond}
...
<<<<<<< HEAD
\begin{DoxyPostcond}{\-Postcondición}
{\bfseries \-Q} $\equiv$ \{res $=_{obs}$ \-Siguiente({\bfseries $\ast$this}) $=_{obs}$ \-Siguiente(other)\}
=======
\begin{DoxyPostcond}{Postcondición}
