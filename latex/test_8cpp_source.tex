...
00424 \textcolor{preprocessor}{}\textcolor{preprocessor}{#define TIEMPO\_DELETE 0.5}
00425 \textcolor{preprocessor}{}\textcolor{preprocessor}{#define TIEMPO\_ITERATE 0.5}
...
00438         \}
00439         \textcolor{comment}{// Diferencia. Dividimos por los clocks por segundo para evitar que no
       dependa del usuario}
00440         \textcolor{keyword}{auto} diff = float( clock () - begin\_time\_insert ) /  CLOCKS\_PER\_SEC;
00441         \textcolor{comment}{//~ std::cout << "tiempo insert con hint bueno (O(1) amortizado)" <<
       diff << std::endl;}
...
00458         ASSERT\_EQ(160000, mapTest.\hyperlink{classaed2_1_1map_a89f2613f926ac13293eafe65889d6021_a89f2613f926ac13293eafe65889d6021}{size}());
00459     \}
00460 
...
00467         \textcolor{comment}{//~ std::cout << "tiempo iterate (O(n) amortizado): " << diff <<
       std::endl;}
